  ...
  return (
    <div className="w-full">
      ...
      >
        {/* Gradient Overlay */}
        <div 
          className="absolute inset-0 z-0 attachment-fixed"
          style={{
            background: `
        ...
        <div className="container mx-auto px-6 relative z-10 pt-20">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <h1 className="text-4xl md:text-5xl text-white font-bold mb-6">Corporate <span className="text-gold">Profile</span></h1>
      ...
      <section className="py-24 bg-navy/5">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                icon: <FiZap className="text-gold text-2xl mb-4" />,
                title: "Hospitality Specialist",
                desc: "Deep understanding of hotels, restaurants, lounges, and nightclub logistics requirements."
              },
              {
                icon: <FiAward className="text-gold text-2xl mb-4" />,
                title: "Retail Excellence",
                desc: "Expertise in handling supermarkets, wine distribution, and imported meats supply chains."
              },
              {
                icon: <FiBox className="text-gold text-2xl mb-4" />,
                title: "Operational Flexibility",
                desc: "Fast, secure, and economical delivery tailored to dynamic trade demands."
              }
            ].map((item, index) => (
              <motion.div
                key={index}
              ...
              >
                {item.icon}
                <h3 className="font-bold text-navy mb-4 text-lg">{item.title}</h3>
